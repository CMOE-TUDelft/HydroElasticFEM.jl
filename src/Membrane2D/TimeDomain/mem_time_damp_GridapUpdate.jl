...
res(t, (ϕ,κ,η), (w,u,v)) = 
  m(t, (∂tt(ϕ),∂tt(κ),∂tt(η)), (w,u,v)) + 
  c(t, (∂t(ϕ),∂t(κ),∂t(η)), (w,u,v)) + 
  a(t, (ϕ,κ,η), (w,u,v)) - 
  l(t, (w,u,v))

res_ql(t, (ϕ,κ,η), (w,u,v)) = 
  c(t, (∂t(ϕ),∂t(κ),∂t(η)), (w,u,v)) + 
  a(t, (ϕ,κ,η), (w,u,v)) - 
  l(t, (w,u,v))
...
# op = TransientFEOperator(res, X, Y, order=2)
op = TransientLinearFEOperator((a, c, m), l, X,Y)
# op = TransientSemilinearFEOperator(m, res_ql, X, Y, order=2)
ls = LUSolver()
...
uht = solve(ode_solver,op,t₀,tf, (u0,u0t))
