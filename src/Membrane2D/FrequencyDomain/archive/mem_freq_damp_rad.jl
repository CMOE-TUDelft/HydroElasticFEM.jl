...
name::String = "data/sims_202312/run/mono_freq_free_rad"
order::Int = 2
...
# add_tag_from_tags!(labels_Ω,"surface",[4,6])   # assign the label "surface" to the entity 3,4 and 6 (top corners and top side)
...
add_tag_from_tags!(labels_Ω, "inletEdge", [3])
